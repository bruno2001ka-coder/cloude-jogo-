...
const IDS=['hud','radar','invBtn','destravarBtn','acaoPanel','hint','alertaPolicia','atencaoPolicia','refugioIndicador','avisoPolicia','miraCombate','touch','aimBase','jumpBtn','fireBtn','fireSecondary','armaBtn','miraBtn'];
