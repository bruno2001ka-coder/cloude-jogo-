...
import{atualizarPolicia,atualizarTiroContinuo,jogadorComColete,jogadorComMochila,ocorrenciaAtual}from'./Police.js';
...
const VERSAO_JOGO='2026-09-06-viatura';
...
function quadro(){
  ...
  atualizarViaturas(dt,ocorrenciaAtual());
