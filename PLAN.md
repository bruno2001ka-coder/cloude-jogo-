...
O suporte do carro foi unificado com a malha visual do terreno. Cada roda agora usa a altura da superfície desenhada, a elevação de quina e o raio vertical efetivo conforme a inclinação do próprio eixo, com correção feita pela mola e folga calibrada de 8 mm. Isso evita que o pneu entre no solo em rampas, asfalto e triângulos inclinados sem levantar artificialmente a carroceria.
