...
const larguraPano=(casa.largura-casa.portaVao)/2;
const centroPano=casa.portaVao/2+larguraPano/2;
for(const x of[casa.x-centroPano,casa.x+centroPano])push(`janela-frontal-${x< casa.x?'E':'D'}`,x,casa.z+2.53,1.62,.24,'esquadria',true);
