...
import{createPrototypePads,flattenPrototypeHeight}from'./FarmTerrain.js';
...
const PROTOTYPE_PADS=FARM_PROTOTYPE_MODE?createPrototypePads(elevacaoBase):[];
export function obterElevacao(x,z){
  const h=elevacaoBase(x,z);
  return FARM_PROTOTYPE_MODE?flattenPrototypeHeight(h,x,z,PROTOTYPE_PADS):h;
}
