...
const checks=[
  ['curso de suspensão configurado',/suspensaoCurso:\.12/.test(carro)],
  ['mola configurada',/suspensaoMola:18/.test(carro)],
  ['amortecedor configurado',/suspensaoAmortecedor:4\.2/.test(carro)],
