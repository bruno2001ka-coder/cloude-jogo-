...
const checks=[
  ...
  ['RAM rígida com suspensão curta',/nome:'pickupRamJogador'/.test(pickup)&&/arquivo:'assets\/ram-pickup\.glb'/.test(pickup)&&/rodasQueGiram:4/.test(pickup)&&/suspensaoCurso:\.045/.test(pickup)&&/suspensaoMola:18/.test(pickup)&&/alturaRoda:-\.035/.test(pickup)],
  ['RAM com dimensões proporcionais',/comprimento:2\.45,largura:1\.01,alturaColisao:\.93,raioDisco:\.43/.test(pickup)&&/entreEixos:\.92,meiaBitola:\.43/.test(pickup)],
  ['RAM alinhada no eixo longitudinal',/giroDoModelo:0/.test(pickup)&&/eixo longitudinal Z/.test(pickup)],
