...
const IDS=['hud','radar','invBtn','destravarBtn','acaoPanel','hint','alertaPolicia','atencaoPolicia','refugioIndicador','avisoPolicia','miraCombate','touch','aimBase','jumpBtn','fireBtn','fireSecondary','armaBtn','miraBtn','acelerador','reBtn'];
...
const nomes={hud:'Status e vida',radar:'Radar',invBtn:'Inventário',destravarBtn:'Destravar',acaoPanel:'Ações',hint:'Dicas',alertaPolicia:'Alerta policial',atencaoPolicia:'Atenção',refugioIndicador:'Despiste',avisoPolicia:'Avisos',miraCombate:'Mira de combate',touch:'Joystick esquerdo',aimBase:'Área de mira',jumpBtn:'Pular',fireBtn:'Tiro',fireSecondary:'Gatilho esquerdo',armaBtn:'Trocar arma',miraBtn:'Mira',acelerador:'Acelerador',reBtn:'Ré'};
